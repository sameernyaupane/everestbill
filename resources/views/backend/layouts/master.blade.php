...
<head>
  ...
  <title>EverestBill | Dashboard</title>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset('backend/css/admin-lte.min.css') }}">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('dashboard.index') }}" class="logo">
      ...
      <span class="logo-lg"><b>Everest</b>Bill</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Sameer Nyaupane</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Version</b> Early Alpha
    </div>
    <strong>Copyright &copy; 2017 <a href="{{ route('frontend.index') }}">EverestBill</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- SlimScroll 1.3.0 -->
<script src="{{ asset('backend/plugins/slim-scroll/jquery.slimscroll.min.js') }}"></script>
<!-- ChartJS 1.0.1 -->
